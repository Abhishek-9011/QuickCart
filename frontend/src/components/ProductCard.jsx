...
function ProductCard({ productImage, name = "Product Name", rating, totalPurchases, price, discount = 0 }) {
  ...
  return (
    <div className="group bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 border border-gray-200">
      ...
      <div className="p-4">
        <h3 className="text-lg font-medium text-gray-900 mb-1 truncate">{name}</h3>
        ...
        <button className="w-full flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-md transition-colors gap-2">
